...
import { PlayButton } from '../Footer/partials/PlayButton';
...
export const Footer = ({ artist, music, cover }: Props) => {
  return (
    <footer className="sticky bottom-0 bg-zinc-950 border-t text-white border-t-zinc-700 px-6 py-4 md:flex-row flex-col flex items-center md:justify-between gap-4">
